...
def draw_lines(color=WHITE):
 ...
 # checks all Information on the board       
...
def check_win(player,check_board=board):
    ...
    for row in range(BOARD_COLS):
        if check_board[row][0]== player and check_board[row][1]== player and check_board[row][2]== player:
            return True
    if check_board[0][0] == player and check_board[1][1] == player and check_board[2][2] == player:#Diagonal Check from the right
       return True
    if check_board[0][2] == player and check_board[1][1] == player and check_board[2][0] == player: #Diagonal Check from the left
       return True
